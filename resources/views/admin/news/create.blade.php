                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local"
                               ...
                               class="w-full px-4 py-2 rounded-lg border-2 border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary focus:ring-opacity-50 transition-all duration-300 @error('published_at') border-red-500 @enderror bg-gray-50"
                               required
                               readonly>
                        <p class="mt-1 text-xs text-gray-500">
                            <i class="fas fa-info-circle mr-1"></i>
                            Tanggal publikasi otomatis diatur ke waktu sekarang
                        </p>
                        @error('published_at')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
