        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="answer" id="answer" rows="4" required
                          class="mt-1 w-full rounded-md border-gray-300 focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">{{ old('answer', $faq->answer) }}</textarea>
                @error('answer')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="order" id="order" required value="{{ old('order', $faq->order) }}" min="0"
