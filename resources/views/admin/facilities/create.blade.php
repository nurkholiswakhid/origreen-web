...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-3xl font-bold text-gray-800">Tambah Wahana/Fasilitas</h1>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
    <div class="border-b border-gray-100 bg-gradient-to-r from-primary/10 to-indigo-50 px-6 py-4 flex items-center text-gray-700">
        ...
        <span class="font-semibold">Form Tambah Data Wahana/Fasilitas</span>
    </div>
        ...
        <form action="{{ route('admin.facilities.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-6 border border-blue-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Icon -->
                    <label
                        class="block p-4 bg-white border-2 rounded-xl cursor-pointer hover:border-primary/80 hover:shadow-md transition-all group">
                        <div class="flex items-center">
                            <div class="shrink-0">
                                <div
                                    class="w-12 h-12 rounded-lg bg-blue-50 flex items-center justify-center group-hover:bg-blue-100 transition">
            ...
            <div class="space-y-6">
                <div class="image-section bg-blue-50 p-4 rounded-xl border border-blue-100"
                    style="display: {{ old('display_type') === 'image' ? 'block' : 'none' }}">
                ...
                <div class="main-icon-section bg-blue-50 p-4 rounded-xl border border-blue-100"
                    style="display: {{ old('display_type', 'icon') === 'icon' ? 'block' : 'none' }}">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Pilih Icon Utama
                    </label>
                    <div class="relative">
            ...
            <div class="mt-6">
                ...
                <select name="type" id="type"
                    ...
                    <option value="wahana" {{ old('type')==='wahana' ? 'selected' : '' }}>Wahana
                        Permainan/Hiburan</option>
...
<script
    src="https://cdn.jsdelivr.net/npm/fontawesome-iconpicker@3.2.0/dist/js/fontawesome-iconpicker.min.js"></script>
<script>
    $(document).ready(function () {
        ...
        $('.main-icon-picker').iconpicker(settings).on('iconpickerSelected', function (e) {
            $(this).siblings('input[type="hidden"]').val(e.iconpickerValue);
        });

        $('.icon-picker').iconpicker(settings).on('iconpickerSelected', function (e) {
            $(this).siblings('input[type="hidden"]').val(e.iconpickerValue);
        });
