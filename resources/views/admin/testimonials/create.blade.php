...
<div class="mb-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600 text-sm">Tambahkan testimonial baru dari pelanggan</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
    <div class="border-b border-gray-100 bg-gray-50 px-6 py-4">
        <h2 class="font-medium text-gray-700">Form Testimoni</h2>
    </div>
                ...
                <div class="flex items-start space-x-6">
                    <div class="flex-shrink-0">
                        <div id="avatar-preview" class="h-32 w-32 rounded-lg border-2 border-gray-200 overflow-hidden relative group">
                            <img src="{{ old('avatar_url') ?? asset('images/default-avatar.png') }}"
                                 alt="Avatar Preview"
            ...
            <div class="mt-6">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <textarea name="content" id="content" rows="4" required
                              ...
                              placeholder="Masukkan ulasan pelanggan">{{ old('content') }}</textarea>
                </div>
                @error('content')
                    <p class="mt-1 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                @enderror
            ...
            <div class="mt-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border-2 border-gray-200">
                    <div class="flex items-center space-x-2">
                        ...
                        @endfor
                        <span class="ml-2 text-sm text-gray-600" id="rating-text">5 Bintang</span>
                    </div>
                </div>
